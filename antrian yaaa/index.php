...
<head>
  ...
  <!-- Title -->
  <title>Antrian pendaftaran ulang</title>

  <!-- Favicon icon -->
  <link rel="shortcut icon" href="assets/img/IMG_0892.png" type="image/x-icon">
  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang di <strong>Aplikasi Antrian pendaftaran ulang SMK DARUS SYIFA CILEGON</strong>. Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2024 - <a href="sudahran27" target="_blank" class="text-danger text-decoration-none">sudahran27</a>. All rights reserved.
      </div>
    </div>
  </footer>
